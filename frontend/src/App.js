...
import AdminLessonDetails from "./pages/AdminLessonDetails";
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink-100 flex flex-col overflow-x-hidden w-full selection:bg-brand-500/30 selection:text-brand-200">
      ...
      <main
        className={
          isDashboardRoute
            ...
            : "relative z-10 w-full flex-1 px-4 sm:px-6 lg:px-10 pb-10 pt-4 min-w-0"
        }
      >
      ...
      {!isDashboardRoute && <Footer key={sessionVersion} />}
    </div>
  );
}
