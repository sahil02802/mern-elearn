...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Facebook, href: "https://www.facebook.com/sahil.vala.98434/", label: "Facebook" },
    { icon: Instagram, href: "https://www.instagram.com/sahil_28_2", label: "Instagram" },
    { icon: Twitter, href: "https://twitter.com", label: "Twitter" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/sahil-vala-59a26b290/", label: "LinkedIn" },
  ];
  ...
  return (
    <footer className="relative border-t border-white/5 bg-canvas mt-auto pt-16 pb-8 overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-ink-400 text-sm leading-relaxed max-w-xs">
              Elevate your skills with our premium e-learning platform.
              Modern courses, expert instructors, and a community of learners.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2 rounded-lg bg-surfaceHighlight/50 text-ink-400 hover:text-white hover:bg-brand-500 hover:shadow-glow-hover transition-all duration-300"
                >
                  <social.icon size={18} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-ink-400">
              <li className="flex items-start gap-3">
                ...
                <span>45 Girnar Society,<br />Surat City, Tech State 394107</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-brand-400 shrink-0" />
                <a href="mailto:support@studypoint.com" className="hover:text-white transition-colors">support@studypoint.com</a>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-brand-400 shrink-0" />
                <a href="tel:+919427025075" className="hover:text-white transition-colors">+91 90230 28234</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-ink-600">
            <Link to="/privacy" className="hover:text-ink-400 transition-colors">Privacy</Link>
            <Link to="/terms" className="hover:text-ink-400 transition-colors">Terms</Link>
            <Link to="/sitemap" className="hover:text-ink-400 transition-colors">Sitemap</Link>
          </div>
        </div>
      </div>
    </footer>
