...
export default function Register() {
	...
	async function submit(e) {
		...
		try {
			...
			// 2. Redirect to VerifyOtp page with form data (we will complete registration there)
			...
			<div className="hidden lg:flex relative bg-surface items-center justify-center p-12 overflow-hidden">
				...
				<div className="relative z-10 max-w-lg space-y-8">
					...
					<h1 className="text-5xl font-display font-bold text-white">
						Unlock your <br />
						<span className="text-transparent bg-clip-text bg-gradient-brand">Potential Today.</span>
					</h1>

					<p className="text-ink-400 text-lg">
						Create an account to access premium courses, track your certifications, and connect with global mentors.
					</p>
					...
					<div className="space-y-4 pt-4">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-sm text-ink-400">Learn at your own pace, forever.</p>
							</div>
						</div>
						...
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-sm text-ink-400">Get guidance from industry leaders.</p>
							</div>
						</div>
					</div>
				</div>
						...
						<form onSubmit={submit} className="space-y-6">
							...
							<div className="space-y-4">
								<div className="relative">
									<User className="absolute left-3 top-3.5 text-ink-400" size={20} />
									<Input
										name="name"
										value={form.name}
